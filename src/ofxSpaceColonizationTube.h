...
public:
    ...
    template<typename BRANCH>
    static void putIntoMesh(shared_ptr<BRANCH> branch, ofMesh& mesh, ofxSpaceColonizationTubeOptions options){
        add(branch, mesh, defaultOptions);
    };

private:
    template<typename BRANCH>
    static void add(shared_ptr<BRANCH> branch, ofMesh& mesh, ofxSpaceColonizationTubeOptions opt){
